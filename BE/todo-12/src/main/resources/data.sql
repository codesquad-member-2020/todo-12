...
insert into card(title, content, author, deleted, category, category_key) values ('3번제목', '3번내용', '3번저자', true, 2, 2);
...
insert into card(title, content, author, deleted, category, category_key) values ('7번제목', '7번내용', '7번저자', false, 3, 2);

insert into card(title, content, author, deleted, category, category_key) values ('11번제목', '11번내용', '11번저자', false, 1, 0);
insert into card(title, content, author, deleted, category, category_key) values ('22번제목', '22번내용', '22번저자', true, 1, 1);
